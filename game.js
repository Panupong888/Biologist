...
const breathMatchingPairs = [
  { symptom: "เป็นเรื้อรัง เป็นๆ หายๆ นานเป็นเดือน/ปี อาจจะแค่รู้สึกเหนื่อยง่าย หรือหายใจไม่สุดบางช่วง อาจมีเสียงวี้ดเบาๆ เฉพาะตอนหายใจออก ควบคุมได้ด้วยยาพ่นประจำ (Preventer) กระทบคุณภาพชีวิต แต่ไม่เป็นอันตรายถึงชีวิตทันที", disease: "โรคหอบหืด", icon: "🌬️" },
  { symptom: "ไอนานเกิน 3-8 สัปดาห์ จนเจ็บหน้าอก มีเสมหะปริมาณมาก หรือไอเป็นเลือด มีอาการหอบเหนื่อย หายใจถี่ มีเสียงหวีด มีไข้สูงเป็นๆ หายๆ น้ำหนักลด", disease: "หลอดลมอักเสบ", icon: "🤧" },
  { symptom: "เกิดขึ้นทันทีทันใด หรือทรุดลงรวดเร็วในไม่กี่นาที/ชั่วโมง หายใจหอบถี่ หายใจลำบากมากจนพูดไม่ได้เป็นประโยค เสียงวี้ดดังชัดเจน หรือในเคสที่อันตรายมาก \"เสียงวี้ดอาจหายไป\" (เพราะลมเข้าไม่ได้เลย) ยาพ่นขยายหลอดลมปกติ (Reliever) อาจเอาไม่อยู่ หรือต้องพ่นซ้ำบ่อยๆ อันตรายถึงชีวิต หากไม่ได้รับการรักษาเร่งด่วน", disease: "หอบหืดเฉียบพลัน", icon: "⚠️" },
  { symptom: "ไอเรื้อรังแบบมีเสมหะ (มักเป็นมากในช่วงเช้า) เหนื่อยง่ายเวลาออกแรง แม้เพียงกิจกรรมปกติในชีวิตประจำวัน และมีอาการหายใจลำบากหรือมีเสียงวี้ดร่วมด้วย ซึ่งอาการเหล่านี้จะค่อยๆ ทรุดลงตามกาลเวลาและไม่สามารถกลับมาเป็นปกติได้ 100%", disease: "โรคปอดอุดกั้นเรื้อรัง", icon: "💨" },
  { symptom: "ไอเรื้อรังติดต่อกันเกิน 2-3 สัปดาห์ขึ้นไป โดยอาจมีเสมหะปนเลือดร่วมด้วย ร่วมกับอาการทางร่างกายทั่วไปอย่าง ไข้ต่ำๆ (มักเป็นช่วงบ่ายหรือเย็น) เหงื่อออกมากผิดปกติในตอนกลางคืน น้ำหนักตัวลดลงอย่างรวดเร็วโดยไม่ทราบสาเหตุ และมีอาการอ่อนเพลียเบื่ออาหาร", disease: "วัณโรค", icon: "🩸" },
  { symptom: "มีไข้สูง หนาวสั่น ไออย่างรุนแรงพร้อมเสมหะข้น (สีเหลือง เขียว หรือสนิม) และมีอาการ เจ็บหน้าอกแปล๊บ เวลาหายใจเข้าหรือไอ หากเป็นรุนแรงจะเกิดภาวะหายใจหอบถี่ ปลายมือปลายเท้าเขียวคล้ำ และสับสนซึมลงเนื่องจากขาดออกซิเจน", disease: "ปอดบวม", icon: "🔥" }
];
