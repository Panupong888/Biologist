...
const arterialQuestions = [
  ...
  },
  {
    ...
    answers: ["มีผนังเพียง 1 ชั้นเซลล์ทำให้แลกเปลี่ยนได้ง่าย", "มีผนังหนาและแข็ง", "มีลิ้นหัวใจควบคุม", "มีระบบกรองเพิ่มเติม"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["ปัสสาวะ", "เหลือง", "อาการเหงื่อ", "น้ำลาย"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["หัวใจห้องบนซ้ายและห้องล่างซ้าย", "หัวใจห้องบนขวาและห้องล่างขวา", "หัวใจด้านซ้ายและด้านขวา", "หลอดเลือดและหัวใจ"],
    correct: 0,
    explanation: "ลิ้นไมทรัลอยู่ระหว่างหัวใจห้องบนซ้ายและห้องล่างซ้าย ป้องกันเลือดไหลย้อนกลับ"
  },
  {
    situation: "คุณกำลังเดินทางในท่อไข่ที่บรรทุกเหลี่ยมเลือด",
    question: "เหลี่ยมเลือดแดง (Red Blood Cell) มีอายุการใช้งานนานเท่าไหร่?",
    answers: ["ประมาณ 120 วัน", "ประมาณ 30 วัน", "ประมาณ 1 ปี", "ตลอดชีวิต"],
    correct: 0,
    explanation: "เหลี่ยมเลือดแดงมีอายุการใช้งานประมาณ 120 วัน หลังจากนั้นจะถูกทำลายในม้าม"
  },
  {
    situation: "คุณเดินทางมาถึงหลอดเลือดแดงใจใหญ่",
    question: "หลอดเลือดแดงซึบคลาเวียนขวา (Right Subclavian artery) เลี้ยงส่วนใด?",
    answers: ["แขนและไหล่ขวา", "ขาขวา", "สมองซ้าย", "ปอด"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["น้ำเงิน/ม่วง", "แดง", "สีชมพู", "สีเหลือง"],
    correct: 0,
    explanation: "เลือดที่มีคาร์บอนไดออกไซด์สูงปรากฏเป็นสีม่วงน้ำเงิน เนื่องจากฮีโมโกลบิน"
  },
  {
    situation: "คุณกำลังเดินทางผ่านจุดที่หลอดเลือดแดงและดำมีวาล์วควบคุม",
    question: "ลิ้นเอออร์ติก (Aortic valve) มีหน้าที่อะไร?",
    answers: ["ป้องกันเลือดไหลย้อนกลับจากเอออร์ตาไปหัวใจ", "เพิ่มความดันเลือด", "ช่วยในการสูบฉีดเลือด", "กรองเลือด"],
    correct: 0,
  ...
  {
    situation: "คุณเดินทางผ่านส่วนที่เหลี่ยมเลือดผ่านการแลกเปลี่ยนก๊าซ",
...
const venousQuestions = [
  ...
  },
  {
    ...
    answers: ["เลี้ยงเนื้อกล้ามเนื้อของหัวใจ", "นำเลือดไปยังปอด", "นำเลือดไปยังสมอง", "นำเลือดกลับจากขา"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["สมอง (20%)", "หัวใจ (5%)", "ตับ (25%)", "ไต (20%)"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["นำเลือดจากขากลับสู่หัวใจ", "นำเลือดไปยังขา", "แลกเปลี่ยนก๊าซ", "กรองของเสีย"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["ปอดซ้ายมี 2 葉 ปอดขวามี 3 葉", "ปอดขวามี 2 葉 ปอดซ้ายมี 3 葉", "ปอดทั้งคู่มี 3 葉 ", "ไม่มีความแตกต่าง"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["120/80 mmHg", "100/60 mmHg", "140/90 mmHg", "90/50 mmHg"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["แดงเนื้อหนาและมีความดันสูง ดำเนื้อบางและมีความดันต่ำ", "ตรงกันข้าม", "ไม่มีความแตกต่างในความหนา", "ดำมีความดันสูงกว่า"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["ม้าม (Spleen)", "ตับ", "ไต", "ลิ้นหัวใจ"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["ป้องกันเลือดไหลย้อนกลับ", "เพิ่มความดันเลือด", "ลดการติดเชื้อ", "เพิ่มอุณหภูมิเลือด"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["หลอดเลือดแดงไปยังตับ (Portal vein)", "หลอดเลือดแดงเอออร์ตา", "หลอดเลือดดำเวนา คาวา", "หลอดเลือดแดงเมเสนทรี"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["หลอดเลือดดำเวนา คาวาบน", "หลอดเลือดแดงเอออร์ตา", "หัวใจห้องบนขวา", "ไต"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["หลอดเลือดดำแบซิลิค (Basilic vein)", "หลอดเลือดแดงตำแหน่ง", "หลอดเลือดดำเซฟาลิก", "หลอดเลือดแดงอัลนาร์"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["การเผาผลาญ", "ความดันโลหิต", "ระดับน้ำตาล", "ระดับแคลเซียม"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["เวนูลเล็กกว่า ต่ออยู่กับหลอดเลือดฝอย", "เวนูลใหญ่กว่า", "เวนูลมีลิ้นหัวใจ ดำไม่มี", "ไม่มีความแตกต่าง"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["เวนา รีนาลิส (Renal vein)", "หลอดเลือดแดงเรนัล", "เวนา ลัมบาร์", "เวนา ไซยาติก"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["เวนา คาวา ซูเปริเอร์ (บน) และอินฟีเรียร์ (ล่าง)", "เวนา คาวา ซ้าย และขวา", "เวนา คาวา แดง และน้ำเงิน", "เวนา คาวา ภายในและนอก"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["นำเลือดจากลำไส้เล็กไปยังตับเพื่อผ่านการกรอง", "นำเลือดออกจากตับ", "เลี้ยงตับ", "แลกเปลี่ยนก๊าซในตับ"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["4 ลำ (2 จากปอดแต่ละข้าง)", "2 ลำ", "6 ลำ", "8 ลำ"],
    correct: 0,
  ...
  },
  {
    ...
    answers: ["หลอดเลือดแดงซับคลาเวียน หลอดเลือดแดงแบซิลิส แลสโรลิค", "หลอดเลือดแดงแบรนเชียล", "หลอดเลือดแดงดิจิทัล", "หลอดเลือดแดงท้องแถบ"],
    correct: 0,
...
const breathTimedQuestions = [
  ...
  },
  {
    ...
    answers: ["แลกเปลี่ยนก๊าซออกซิเจนและคาร์บอนไดออกไซด์", "ฟอกอากาศ", "ความชื้นของอากาศ", "ลดเสียง"],
    correct: 0
  },
  {
    question: "กล่องเสียง (Larynx) มีหน้าที่อะไร?",
    answers: ["ผลิตเสียงและป้องกันการเข้าของอาหาร", "กรองอากาศ", "ความชื้นอากาศ", "แลกเปลี่ยนก๊าซ"],
    correct: 0
  },
  {
    question: "จมูกมีหน้าที่ใด?",
    answers: ["กรองและอุ่นอากาศก่อนเข้าปอด", "ผลิตเสียง", "แลกเปลี่ยนก๊าซ", "กรองเลือด"],
    correct: 0
  },
  {
    question: "หลอดลมหลัก (Bronchi) แบ่งออกเป็นกี่ส่วน?",
    answers: ["2 ส่วน (ซ้ายและขวา)", "3 ส่วน", "4 ส่วน", "หลายส่วนไม่มีจำนวนที่แน่นอน"],
    correct: 0
  },
  {
    question: "ม้านอน (Diaphragm) ทำหน้าที่อะไรในการหายใจ?",
    answers: ["ดึงลง เพื่อดูดอากาศเข้าปอด", "ผลิตอากาศ", "กรองอากาศ", "ปิดก้องลม"],
    correct: 0
  },
  {
    question: "อัตราการหายใจปกติของผู้ใหญ่เป็นเท่าไหร่ต่อนาที?",
    answers: ["12-20 ครั้ง", "30-40 ครั้ง", "50-60 ครั้ง", "5-10 ครั้ง"],
    correct: 0
  },
  {
    question: "โรควัณโรค (Tuberculosis) เกิดจากการติดเชื้ออะไร?",
    answers: ["แบคทีเรีย Mycobacterium tuberculosis", "ไวรัส", "เชื้อรา", "寄生虫"],
    correct: 0
  },
  {
    question: "ปอดบวม (Pulmonary Edema) เกิดจากสาเหตุใด?",
    answers: ["เลือดไหลออกหรืออุมน้ำเข้าไปในถุงลม", "การติดเชื้อ", "โรคหอบหืด", "อากาศสกปรก"],
    correct: 0
  },
  {
    question: "ปัดเป่า (Emphysema) มักเกิดจากสาเหตุใด?",
    answers: ["การสูบบุหรี่เป็นระยะเวลานาน", "การแพ้สารก่อภูมิแพ้", "การติดเชื้อแบคทีเรีย", "สารเคมี"],
    correct: 0
  },
  {
    question: "ปอดบวมขึ้นเนื่องจาก (Pneumonia) คืออะไร?",
    answers: ["การอักเสบของเนื้อปอดจากการติดเชื้อ", "การฉีดเข็ม", "การเจ็บตัว", "การหายใจเร็ว"],
    correct: 0
  },
  {
    question: "ความดันบริเวณปอดที่ช่วยให้อากาศเข้าออกเรียกว่าอะไร?",
    answers: ["Intrapleural pressure", "Intrapulmonary pressure", "Blood pressure", "Osmotic pressure"],
    correct: 0
  },
  {
    question: "การหายใจเข้าเรียกว่าอะไร?",
    answers: ["สูดลม (Inspiration/Inhalation)", "ปล่อยลม (Expiration)", "หายใจเร็ว", "หายใจช้า"],
    correct: 0
  },
  {
    question: "ปลายสายหลอดลม (Bronchioles) ต่ออยู่กับ?",
    answers: ["ถุงลม (Alveoli)", "หลอดลมหลัก", "กล่องเสียง", "จมูก"],
    correct: 0
  },
  {
    question: "ความจุปอดของผู้ใหญ่เป็นเท่าไหร่?",
    answers: ["ประมาณ 6 ลิตร", "ประมาณ 1-2 ลิตร", "ประมาณ 10 ลิตร", "ประมาณ 0.5 ลิตร"],
    correct: 0
  },
  {
    question: "เยื่อหุ้มปอด (Pleura) ทำหน้าที่อะไร?",
    answers: ["ปกป้องปอดและหลั่งของเหลวเพื่อลดแรงเสียดทาน", "ผลิตออกซิเจน", "กรองอากาศ", "สูบฉีดอากาศ"],
    correct: 0
  },
  {
    question: "หลอดลมบอก (Trachea) นำอากาศไปยังไหน?",
    answers: ["หลอดลมหลัก (Bronchi) ของปอด", "กล่องเสียง", "จมูก", "กระเพาะอาหาร"],
    correct: 0
  },
  {
    question: "วัณโรคควรรักษาด้วยอะไร?",
    answers: ["ยาปฏิชีวนะหลายตัวรวมกัน", "ยาหนึ่งตัว", "อากาศบริสุทธิ์เท่านั้น", "ออกซิเจนเสริม"],
    correct: 0
  },
  {
    question: "โรคหอบหืดควรหลีกเลี่ยงอะไร?",
    answers: ["สารก่อภูมิแพ้ เช่น ฝุ่น สัตว์เลี้ยง อากาศเย็น", "น้ำ", "ดวงแดด", "คน"],
    correct: 0
  },
  {
    question: "ช่องหน้าอกมีกี่ซี่โครง?",
    answers: ["12 คู่", "10 คู่", "14 คู่", "8 คู่"],
    correct: 0
  }
];
